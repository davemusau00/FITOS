...
**Implementation evidence (2026-08-28):** Shared `ErrorNotice` now supports an accessible, keyboard-operable Retry action, wired into Ops, Insights, Bookings, Members, Attendance, Memberships, Schedule, Services, Platform Overview, and Platform Tenants query failures. This is a targeted recovery/accessibility improvement; the full responsive and keyboard sweep remains open.
