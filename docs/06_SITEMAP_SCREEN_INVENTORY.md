...
The route inventory now follows [`10_ROLE_SURFACES_AND_AUTH_ARCHITECTURE.md`](10_ROLE_SURFACES_AND_AUTH_ARCHITECTURE.md): `/app/*` is FITOS Command, while `/ops/*`, `/reception/*`, `/coach/*`, `/practice/*`, `/member/*`, and `/platform/*` are separate operating environments over the shared FITOS data model.
