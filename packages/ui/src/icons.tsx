...
const paths: Record<IconName, JSX.Element> = {
  ...
  "eye-off": <><path d="m3 3 18 18M10.6 10.7a2 2 0 0 0 2.7 2.7M9.9 4.2A11.3 11.3 0 0 1 12 4c6.5 0 10 8 10 8a18.5 18.5 0 0 1-3 3.9M6.6 6.6C3.8 8.5 2 12 2 12s3.5 8 10 8c1.8 0 3.3-.5 4.6-1.2" /></>,
  filter: <path d="M4 5h16M7 12h10m-7 7h4" />,
  key: <><circle cx="8" cy="15" r="4" /><path d="m11 12 8-8m-2 0 3 3m-5-1 2 2" /></>,
